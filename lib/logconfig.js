...
;
  ...
  , CompactDoc = "A string that is either \"delete\" or \"compact\". This string " +
    ...
    "Since kafka 0.10.2 it's also possible to set both \"compact,delete\" at the same time."
  ...
  , MinInSyncReplicasDoc = "When a producer sets acks to \"all\" (or \"-1\"), " +
    ...
    "NotEnoughReplicasAfterAppend). When used together, min.insync.replicas and acks " +
